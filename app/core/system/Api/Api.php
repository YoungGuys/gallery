            ...
            foreach ($users as $key => $val) {
                $id_user = $this->db->insert("users",
                    [
                        ...
                        "education_eng" => $val['education_eng'],
                        "country" => $val['country'],
                        "region" => $val['region'],
                        'town' => $val['town'],
                        'town_eng' => $val['town_eng'],
                        'address' => $val['address'],
                        'phone' => $val['phone'],
    ...
    public function put_user() {
        $this->db->update("users",
            [
                ...
                'education_eng' => $_GET['education_eng'],
                'country' => $_GET['country'],
                'region' => $_GET['region'],
                'town' => $_GET['town'],
                'town_eng' => $_GET['town_eng'],
